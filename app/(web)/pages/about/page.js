  ...
  return (
    <div>
      <section class="mx-auto max-w-4xl px-4 py-8">
        <h1 class="mb-4 text-3xl font-bold">About BibleVis</h1>
        <p class="mb-4">
        ...
        <h2 class="mb-4 text-2xl font-semibold">What Makes BibleVis Unique?</h2>
        <ul class="mb-8 list-disc space-y-2 pl-5">
          <li>
